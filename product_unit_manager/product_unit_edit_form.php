...
<div class="row">
  ...
  <div class="col-md-12">
    ...
    <div class="card-header">
        <h3 class="card-title"> Edit Product Unit Data</h3>
    </div>
    <!-- /.card-header -->
     <!-- /.card-header -->
            <?php 
            ...
            $id = $_REQUEST['id'];
            $edit_query = "SELECT * FROM snit_product_unit_list WHERE id = $id";
    ...
    <form id="quickForm" action="edit_action.php?id=<?php echo $id ?>" method="POST" enctype="multipart/form-data">
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <input type="text" name="productname" class="form-control" id="exampleInputEmail1" placeholder="Enter Product Name"  value="<?php echo $row['unit_name']; ?>">
        </div> 
        <div class="form-group">
