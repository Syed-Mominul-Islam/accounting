        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Please Edit <small>Permission</small></h3>
            </div>
            <!-- /.card-header -->
            <?php 
           
            $id = $_REQUEST['id'];
            $edit_query = "SELECT * FROM snit_permission_list WHERE id = $id";
            ...
            <form id="quickForm" action="edit_action.php?id=<?php echo $id ?>" method="POST">
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" name="permission" class="form-control" id="exampleInputEmail1" placeholder="Enter Permission Name" value="<?php echo $row['permission_name']; ?>">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Permission Slug</label>
                  <input type="text" name="permissionslug" class="form-control" id="exampleInputEmail1" placeholder="Permission Slug" value="<?php echo $row['permission_slug']; ?>">
                </div>
                <div class="form-group">
