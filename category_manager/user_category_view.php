...
<div class="content-wrapper">
  ...
  <ol class="breadcrumb float-sm-right">
    ...
    <li class="breadcrumb-item active">User Category Details</li>
  </ol>
  </div>
  </div>
  </div><!-- /.container-fluid -->
  ...
  <div class="card-header">
      <h3 class="card-title">User <b>Category</b> details</h3>
      ...
      <table class="table table-striped projects">
        ...
        <tbody>
          <?php 
            ...
            $id = $_REQUEST['id'];
            $view_query = "SELECT * FROM snit_category_list WHERE id = $id";
            $result = $db->query($view_query);
            $row = mysqli_fetch_array($result);
            ?>
            <tr><td>ID</td><td><?php echo $row['id']; ?></td></tr>
            <tr><td>Role Name</td><td><?php echo $row['category_name']; ?></td></tr>
