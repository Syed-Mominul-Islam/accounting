...
<div class="content-wrapper">
 ...
 <section class="content-header">
  ...
  <div class="col-sm-6 text-right">
    <a href="/category_manager/category_add_form.php" class="btn btn-primary"><i class="fa fa-plus"></i> Add Category</a>
  </div>
  </div>
  </div><!-- /.container-fluid -->
  </section>
      ...
      <table class="table table-striped projects">
       ...
       <?php
        if($total_rows > $no_of_records_per_page ) {
          echo $account->pagination($pageno, '/category_manager/category_list.php',  $range, $total_pages);
        }
      ?>
    </div>
    <!-- /.card-body -->
