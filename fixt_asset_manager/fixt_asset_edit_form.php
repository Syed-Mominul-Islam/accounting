  ...
  <section class="content">
    <div class="container-fluid">
      <div class="row">
        ...
        $id = $_REQUEST['id'];
        $edit_query = "SELECT * FROM snit_fixed_asset_list WHERE id = $id";
        ...
        <div class="form-group">
          ...
          <input type="text" name="assetname" class="form-control" id="exampleInputEmail1" placeholder="Enter Asset Name" value="<?php echo $row['asset_name']; ?>">
        </div>
        <div class="form-group">
          <label for="exampleInputEmail1">Salvage Value</label>
          <input type="text" name="salvagevalue" class="form-control" id="exampleInputEmail1" placeholder="Enter Salvage Value" value="<?php echo $row['salvage_value']; ?>">
        </div>
        <div class="form-group">
          <label for="exampleInputEmail1">Useful Years</label>
          <input type="text" name="usefulyears" class="form-control" id="exampleInputEmail1" placeholder="Enter Useful Years" value="<?php echo $row['useful_years']; ?>">
        </div>
         <div class="form-group">
