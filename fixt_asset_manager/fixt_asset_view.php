...
<div class="content-wrapper">
  ...
  <ol class="breadcrumb float-sm-right">
    ...
    <li class="breadcrumb-item active">Fixed Asset Details</li>
  </ol>
  </div>
  </div>
  </div><!-- /.container-fluid -->
  ...
  <div class="card-header">
      <h3 class="card-title">Fixed Asset <b>Details</b></h3>
    ...
    <div class="card-body p-0">
      <table class="table table-striped projects">
        ...
        <tbody>
          <?php 
            $id = $_REQUEST['id'];
            $view_query = "SELECT * FROM snit_fixed_asset_list WHERE id = $id";
            $result = $db->query($view_query);
            $row = mysqli_fetch_array($result);
          ?>
            <tr><td>Asset Name</td><td><?php echo $row['asset_name']; ?></td></tr>
            <tr><td>Salvage Value</td><td><?php echo $row['salvage_value']; ?></td></tr>
            <tr><td>Useful Years</td><td><?php echo $row['useful_years']; ?></td></tr>
            <tr><td>Status</td><td><?php echo $row['status']; ?></td></tr>
            <tr><td>Deleted</td><td><?php echo $row['deleted']; ?></td></tr>
            <tr><td>Adjusted</td><td><?php echo $row['adjusted']; ?></td></tr>
