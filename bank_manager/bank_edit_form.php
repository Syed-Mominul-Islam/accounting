        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Please Edit <small>Bank Data</small></h3>
            </div>
            <!-- /.card-header -->
            <?php 
           
            $id = $_REQUEST['id'];
            $edit_query = "SELECT * FROM snit_bank_list WHERE id = $id";
            ...
            <form id="quickForm" action="edit_action.php?id=<?php echo $id ?>" method="POST">
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" name="bankname" class="form-control" id="exampleInputEmail1" placeholder="Enter Bank Name" value="<?php echo $row['bank_name']; ?>">
                </div>
                <div class="form-group">
