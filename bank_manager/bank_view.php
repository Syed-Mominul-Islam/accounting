...
<div class="content-wrapper">
  ...
  <div class="card-header">
      <h3 class="card-title">Bank <b>Details</b></h3>
    ...
    <div class="card-body p-0">
      <table class="table table-striped projects">
        ...
        <tbody>
          <?php 
            $id = $_REQUEST['id'];
            $view_query = "SELECT * FROM snit_bank_list WHERE id = $id";
            $result = $db->query($view_query);
            $row = mysqli_fetch_array($result);
          ?>
            <tr><td>Bank Name</td><td><?php echo $row['bank_name']; ?></td></tr>
            <tr><td>Account Number</td><td><?php echo $row['account_number']; ?></td></tr>
